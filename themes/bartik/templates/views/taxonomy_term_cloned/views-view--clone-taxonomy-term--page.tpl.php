...
<div class="<?php print $classes; ?>">
  ...
  <?php if ($rows): ?>
    <div class="view-content-left">
    	<div class="view-content-left-title">
    		<?php print $term->name?>
    	</div>
    	<?php if(isset($term->field_sector_subtitle['und'][0]['value'])):?>
	    	<div class="view-content-left-subtitle">
    			<?php print $term->field_sector_subtitle['und'][0]['value']; ?>
    		</div>
    	<?php endif;?>
    	<?php if(isset($term->description)):?>
    		<div class="view-content-left-body">
    			<?php print $term->description; ?>
    		</div>
    	<?php endif;?>
    	<?php if(isset($term->field_sector_links['und'][0]['url'])):?>
			<div class="view-content-left-links">
				<ul>
					<?php foreach ($term->field_sector_links['und'] as $link):?>
						<?php $attributes = array();?>
						<?php if($current_url == $link['url']):?>
		...
		<?php if($mostrar_volver):?>
			<div class="view-content-left-links-volver">
